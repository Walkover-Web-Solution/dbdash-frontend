...
export default function LoookupDataType(props) {
  ...
  // if(!(props?.linkedValueName) ) props?.setLinkedValueName({foreignKey[0][0]})
console.log(foreignKey[0][1]?.metaData?.foreignKey?.tableId)
console.log(props?.selectedFieldName)
