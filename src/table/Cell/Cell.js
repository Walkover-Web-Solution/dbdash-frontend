...
import SelectFilepopup from "../selectFilepopup/selectFilepopup";
...
const Cell = memo(
  ({
    ...
    switch (dataType) {
      ...
      case "datetime":
        element = (
          <>
            ...
            <input
              type="text"
              className={inputBoxShow?"data-input bgnone dnone":"data-input bgnone dblock"}
              readOnly="readonly"
              value={
                value?.value &&
        ...
        element = (
          <>
            ...
            {showSelect && (
              ...
              >
                <div
                  className="d-flex flex-wrap-wrap mt-05"
      ...
      case "check":
        element = (
          <div key={row.getRowProps().key}   role="row"  className="tr d-flex checkrow ">
            {!row.isSelected && (
