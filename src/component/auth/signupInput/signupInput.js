...
export default function SignupInput(props) {
  ...
  return (
    <Box>
        <Box onSubmit={onSubmitSignup} component="form" className="onSubmitSignup" >

        {/* First name and last name */}
        <Box className="insidesubmit">
        ...
        <Box className="textfieldbox" >
          <TextField error={state?.$errors?.email.length === 0 ?false:state.$errors.email?true:false} className="textfieldo"  required id="email" name='email' type="email" label="Email" variant="outlined" onChange={updateEmail}  onBlur={() => setExplicitField("email", true)} />
        </Box>
            <Box className="errors">
        ...
        <Box className="smalltextfieldbox">
          <Box className="margin1">
            <TextField error={state?.$errors?.password.length === 0 ?false:state.$errors.password?true:false} required className="hieghtwidthauto" id="password" name='password' type="password" label="Password" variant="outlined" onChange={updatePassword}  onBlur={() => setExplicitField("password", true)}/>
              <Box className="errors">
