  ...
  return (
    <>
      ...
      <div className="records-container">
        ...
        To create a new record, you need to make a POST request to the given endpoint. Select/Deselect the checkboxes to make the request and add values in your table.
</Typography>
<br/>
