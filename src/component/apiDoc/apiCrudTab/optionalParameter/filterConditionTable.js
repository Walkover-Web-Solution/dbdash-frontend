...
const FilterConditionTable = (props) => {
  ...
  const tableData = async () => {
    ...
    let obj = {};
    data.map((element) => {
      obj[element.filterCondition] = Object.entries(
    ...
    <Table className="filter-condition-main-table">
      ...
      <TableBody>
        {data.map((row, index) => {
          ...
          return (
            <TableRow
              className="filter-condition-table-body-table-row"
              key={row.filterCondition}
            >
              ...
              <TableCell className="hoverable-cell filter-condition-table-body-table-row-cell">
      ...
      {!showMore ? (
        <Link
          href="#"
          className="table-body-show-more"
