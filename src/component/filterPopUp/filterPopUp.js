      ...
      >
        <Box sx={style}>
          ...
          <Box  className="forthbox" >
            ...
            <Box className="fifthbox">
              ...
              state?.$errors?.filterName.length === 0
                  ...
                  : state.$errors?.filterName
                      ? true
                      : false
          } autoFocus className="errorbox"  value={filterName} type="text" placeholder="enter filter name" onChange={(e) => {setFilterName(e.target.value); createFilterJoi(e);}} onBlur={() => setExplicitField("filterName", true)} />
            </Box>
            <div className="error" >
            ...
            <Box>
              { query.map((q,index)=>(<Box key={index} className="map" >
                        {index==0 && <Box><Typography  className="where">WHERE</Typography></Box>}
                      ...
                      {index!=0  && <Box>
                        ...
                        <Box className="mr1">
                          <Select value ={q?.fields} onChange={(e)=>handleChangeField(e,index)} className="select" >
                        ...
                        <TextField required  value={q?.value} className="textfield"  placeholder="Enter the value" type="text" onChange={(e) => handleChangeValue(e,index)} />
                        </Box>
            ...
            <Box className="marginbottomleft" >
              <Button onClick={handleAddInput}> <AddIcon className="addBtnStyle"/> </Button>
            </Box>
